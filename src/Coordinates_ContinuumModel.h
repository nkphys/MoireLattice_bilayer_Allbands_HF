...
#ifndef Coordinates_ContinuumModel_class
#define Coordinates_ContinuumModel_class
class Coordinates_ContinuumModel  {

public:
    Coordinates_ContinuumModel(int lx, int ly, int n_orbs)
...
void Coordinates_ContinuumModel::Numbering(){
